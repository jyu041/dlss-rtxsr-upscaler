...
The application never substitutes another upscaler when a backend is unavailable. DLSS5 proprietary runtime files are not included or downloaded.
...
- CGI/3D-animation-like video: DLSS 5, Natural, Photoreal Balanced, native first; then optionally the combined workflow.
...
See `docs/INSTALL.md`, `docs/SECURITY_AUDIT.md`, and `docs/TROUBLESHOOTING.md`.
