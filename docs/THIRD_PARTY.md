...
| [Merserk/dlss5-visual-enhancer](https://github.com/Merserk/dlss5-visual-enhancer) v9.0 | MIT for its source; included NVIDIA, mpv GPL/LGPL, Python, FFmpeg, and other binaries retain their respective terms | External DLSS5 Neuroframe candidate inspected for Phase 5; no source or binary is incorporated |
