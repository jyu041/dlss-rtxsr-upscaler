                    ...
                    with gr.Column(scale=35, min_width=360, elem_classes=["workspace-card", "settings-panel"]):
                        ...
                        with gr.Column(visible=dlss_initial, elem_classes=["backend-panel", "backend-dlss"]) as dlss_group:
                            ...
                            with gr.Accordion("Advanced runtime / neural controls", open=False, elem_classes="compact-settings"):
                                ...
                                v10_shimmer_suppression = gr.Slider(0, 1, dlast.get("v10_shimmer_suppression", 0.70), .05, label="Native shimmer suppression", elem_classes="compact-native-control")
                                v10_prefer_nvof = gr.Dropdown(["Off", "On"], value="On" if dlast.get("v10_prefer_nvof", False) else "Off", label="Prefer NVIDIA Optical Flow", elem_classes="compact-native-control")
