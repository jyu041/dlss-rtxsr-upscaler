...
DLSS5_TOOLTIPS = {
    ...
    "shimmer_suppression": "Experimental v3 video control. Stabilizes only the Neural Rendering residual with motion compensation and resets history at scene cuts; 0 disables it.",
    ...
    "v10_nr_passes": "v10 native Neural Rendering pass count. More passes can strengthen the effect and cost more time; no quality ranking is assumed until reviewed on real video.",
    "v10_shimmer": "v10 native temporal residual stabilization control already represented by the isolated protocol. The previous application default is 0.70.",
    "v10_nvof": "Experimental v10 preference for NVIDIA Optical Flow when the runtime accepts it. Keep off unless the bounded A/B matrix proves a benefit.",
